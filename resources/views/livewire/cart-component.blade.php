            ...
            <div class="summary">
                <div class="order-summary">
                    ...
                    @if(Session::has('coupon'))
                        <p class="summary-info"><span class="title">Discount ({{Session::get('coupon')['code']}})<a href="#" wire:click.prevent="removeCoupon" style=" padding-left: 5px; font-size: 20px" ><i class="fa fa-times text-danger"></i></a></span><b class="index"> -${{number_format($discount,2)}}</b></p>
                        <p class="summary-info"><span class="title">Subtotal with Discount ({{config('cart.tax')}}%)</span><b class="index">${{number_format($subtotalAfterDiscount,2)}}</b></p>
