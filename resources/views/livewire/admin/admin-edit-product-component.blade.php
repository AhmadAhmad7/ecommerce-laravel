            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <div class="row">
                            <div class="col-md-6">Edit Products</div>
                        ...
                        <form class="form-horizontal" enctype="multipart/form-data" wire:submit.prevent="update_Product">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    ...
                                    @if($newimage)
                                        <img src="{{$newimage->temporaryUrl()}}" width="120" class="pull-right"/>
                                        @error('newimage') <small class="text-danger"> {{$message}}</small> @enderror
                                        @else
                                          <img src="{{asset('assets/images/products')}}/{{$image}}" width="120" class="pull-right" />
                                    @endif
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <button class="btn btn-primary" style="margin-left: 150px; margin-top: 20px ">Update</button>
                                </div>
                            </div>
