            ...
            <div class="col-lg-9 col-md-8 col-sm-8 col-xs-12 main-content-area">
                ...
                <div class="banner-shop">
                    <a href="#" class="banner-link">
                        ...
                        <figure><img src="{{asset('assets/images/shop-banner.jpg')}}"></figure>
                    </a>
                </div>
                ...
                <div class="row">
                    ...
                    <ul class="product-list grid-products equal-container">
                        @php
                           $waitems = Cart::instance('wishlist')->content()->pluck('id');
                        @endphp
                            ...
                            <div class="product product-style-3 equal-elem ">
                                ...
                                <div class="product-info">
                                    ...
                                    <div class="product-wish">
                                        @if($waitems->contains($product->id))
                                        <a href="#" wire:click.prevent="deleteFormWishlist({{$product->id}})"><i class="fa fa-heart fill-heart"></i></a>
                                        @else
                        ...
                        <ul class="products">
                            ...
                            <li class="product-item">
                                <div class="product product-widget-style">
                                    ...
                                    <div class="product-info">
                                        <a href="#" class="product-name"><span>Radiant-360 R6 Wireless Omnidirectional Speaker...</span></a>
                                        <div asdsad="ads" class="wrap-price"><span class="product-price">$168.00</span></div>
                                    </div>
                                </div>
                            </li>
