<main id="main" class="main-site">
    ...
    <style>
        .summary-item .row-in-form input[type="password"], .summary-item .row-in-form input[type="text"]{
            font-size: 13px;
            line-height: 19px;
                    ...
                    <div class="wrap-address-billing">
                        ...
                        <div class="billing-address">
                            ...
                            <p class="row-in-form">
                                ...
                                <input  type="text" name="city" value="" placeholder="Province" wire:model="province">
...
{{--                        <p class="row-in-form">--}}
{{--                            <label for="card-no">Expiry Year:</label>--}}
...
{{--                            <input  type="password" name="exp-year" value="" placeholder="CVC" wire:model="cvc">--}}
