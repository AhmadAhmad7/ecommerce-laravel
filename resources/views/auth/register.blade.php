                            ...
                            <div class="register-form form-item ">
                                ...
                                <form class="form-stl" action="{{route('register')}}" name="frm-login" method="POST" >
                                    ...
                                    <fieldset class="wrap-input">
                                        ...
                                        <input type="text" id="name" name="name" placeholder="Your Name" required autofocus autocomplete="name">
                                    </fieldset>
                                    <fieldset class="wrap-input">
                                        <label for="frm-reg-email">Email Address*</label>
                                        <input type="email" id="email" name="email" placeholder="Email address" required autofocus autocomplete="email">
                                    </fieldset>
