                            ...
                            @if(Route::has('login'))
                                ...
                                @auth()
                                    @if(Auth::user()->utype === 'ADM')
                                        ...
                                        <li class="menu-item menu-item-has-children parent" >
                                            <a title="My Account (USD)" href="#">My Account ({{Auth::user()->name}})<i class="fa fa-angle-down" aria-hidden="true"></i></a>
                                            <ul class="submenu curency" >
                                                <li class="menu-item" >
                                                ...
                                                <li class="menu-item">
                                                    <a title="Manage HomeSlider" href="{{route('admin.home_slider')}}">Manage Home Slider</a>
                                                </li>

                                                <li class="menu-item">
                                                    <a title="Manage Home Categories" href="{{route('admin.home_categories')}}">Manage Home Categories</a>
                                                </li>
...
<script src="https://cdn.tiny.cloud/1/xvi8oecqneqgzj6xl3mgzsvauun6hmi8jixuq2iqnbkq971n/tinymce/6/tinymce.min.js" referrerpolicy="origin"></script>
